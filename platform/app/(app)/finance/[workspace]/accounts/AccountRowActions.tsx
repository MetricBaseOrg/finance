...
import type { FinAccountType } from "@/app/generated/prisma/client";
  ...
  return (
    <div className="flex items-center justify-end gap-4">
      ...
      <button
        ...
        disabled={pending}
        className="font-mono rounded-lg text-[10px] uppercase tracking-[0.2em] text-gray-3 hover:text-gold transition-colors disabled:opacity-50"
      >
