      ...
      >
        ...
        <div className="flex gap-2 justify-end">
          ...
          <button
            ...
            className="font-mono rounded-lg text-[10px] uppercase tracking-[0.18em] text-gray-3 hover:text-gold transition-colors"
          >
            ✕
          </button>
        </div>
    ...
    <div className="grid grid-cols-[1fr_80px_60px] sm:grid-cols-[1fr_140px_80px] gap-2 px-4 py-3 border-b border-line last:border-b-0 items-center hover:bg-[var(--color-bg-hover)] transition-colors">
      ...
      <div className="flex gap-3 justify-end">
        <button
          ...
          className="font-mono rounded-lg text-[10px] uppercase tracking-[0.2em] text-gray-3 hover:text-gold transition-colors"
        >
          Edit
        </button>
        <button
          ...
          disabled={pending}
          className="font-mono rounded-lg text-[10px] uppercase tracking-[0.2em] text-gray-3 hover:text-[var(--color-down)] transition-colors disabled:opacity-50"
        >
          {pending ? "…" : "Del"}
        </button>
      </div>
