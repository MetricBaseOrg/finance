  ...
  return (
    <div className="flex flex-col gap-8 max-w-[1240px]">
      ...
      <form className="mb-card p-4 flex flex-wrap gap-3 items-end">
        ...
        <button
          type="submit"
          className="font-mono rounded-lg text-[11px] uppercase tracking-[0.18em] text-black bg-gold hover:bg-gold-bright px-4 py-2.5"
        >
          Apply
        </button>
        ...
        <Link
          ...
          className="font-mono rounded-lg text-[11px] uppercase tracking-[0.18em] text-gold border border-gold hover:bg-gold hover:text-black px-4 py-2.5 transition-colors"
        >
          Export CSV
        </Link>
        <Link
