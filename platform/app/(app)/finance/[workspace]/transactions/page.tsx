    ...
    return (
      <div className="flex flex-col gap-8 max-w-[1240px]">
        ...
        <BunEmpty
          ...
          action={
            <Link
              href={`/finance/${slug}/accounts`}
              className="font-mono rounded-lg text-[11px] uppercase tracking-[0.2em] text-gold hover:text-gold-bright"
            >
              → Go to Accounts
            </Link>
          }
    ...
    <div className="flex flex-col gap-8 max-w-[1240px]">
      <header className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <Link
          ...
          className="self-start sm:self-auto font-mono rounded-lg text-[11px] uppercase tracking-[0.18em] text-gold border border-gold hover:bg-gold hover:text-black px-4 py-2.5 transition-colors"
        >
          Export CSV
        </Link>
      </header>
...
function PageLink({
  ...
  return (
    <Link
      href={`/finance/${slug}/transactions?${params.toString()}`}
