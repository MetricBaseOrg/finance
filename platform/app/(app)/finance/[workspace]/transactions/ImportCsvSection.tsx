    ...
    <div className="mb-card p-5 flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        <button
          ...
          className="font-mono rounded-lg text-[10px] uppercase tracking-[0.18em] text-gold border border-gold hover:bg-gold hover:text-black px-3 py-2 transition-colors shrink-0"
        >
          Download Template
        </button>
        ...
        <form action={formAction} className="flex flex-1 gap-3 items-center flex-wrap">
          ...
          <button
            type="submit"
            disabled={pending}
            className="font-mono rounded-lg text-[10px] uppercase tracking-[0.18em] text-black bg-gold hover:bg-gold-bright px-3 py-2 transition-colors disabled:opacity-50 shrink-0"
          >
