  ...
  return (
    <div className="flex flex-col gap-8 max-w-[1240px]">
      <header className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-3">
        ...
        <Link
          href={`/finance/${slug}/settings/categories`}
          className="font-mono rounded-lg text-[11px] uppercase tracking-[0.18em] text-gold hover:text-gold-bright self-start sm:self-auto"
        >
          Manage categories →
        </Link>
      </header>
