  ...
  return (
    <main className="flex-1 px-4 sm:px-6 py-8 max-w-4xl mx-auto w-full">
      <div className="flex flex-col gap-8">
        <Link
          href={`/finance/${slug}/transactions`}
                      ...
                      >
                        ...
                        <td className="px-3 sm:px-6 py-3 text-right flex gap-1 sm:gap-2 justify-end text-xs sm:text-sm">
                          <button
                            ...
                            className="font-mono rounded-lg text-[10px] uppercase tracking-[0.2em] text-gold hover:text-white transition-colors"
                          >
                            Edit
                          </button>
                          <button
                            ...
                            className="font-mono rounded-lg text-[10px] uppercase tracking-[0.2em] text-[var(--color-down)] hover:text-white transition-colors disabled:opacity-50"
                          >
